...
import com.nvoulgaris.cosmoseye.apod.domain.PictureDetailsInteractor
...
import com.nvoulgaris.cosmoseye.apod.presentation.PictureDetailsViewModel
...
class PictureDetailsShould {
    ...
    fun streamPictureFromDb() {
        ...
        val viewModel = PictureDetailsViewModel(interactor, mapper, DATE)
